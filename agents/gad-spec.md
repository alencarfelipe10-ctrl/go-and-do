---
name: gad-spec
description: Filho de camada 2 da etapa de intenção da /go-and-do — hospeda o gsd-spec-phase em janela descartável para que o workflow (~33KB) não resida na camada 1. Despachado pelo subagente de intenção via prompts/intent-spec.md; não invocar fora dela. Migrado para Opus 5.5 / effort medium em 22/09/2026 (Anthropic: 5.5 em medium ≥ Opus 5 em high; cache read caiu de US$ 0,50 para 0,20/M, a fatia que os hospedeiros mais pagam).
